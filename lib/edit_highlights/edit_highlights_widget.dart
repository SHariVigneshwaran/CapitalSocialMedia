...
class EditHighlightsWidget extends StatefulWidget {
  const EditHighlightsWidget({Key? key}) : super(key: key);

  @override
  _EditHighlightsWidgetState createState() => _EditHighlightsWidgetState();
}

class _EditHighlightsWidgetState extends State<EditHighlightsWidget> {
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            'Fill out your highlights details below! And then get to sharing your highlights!',
