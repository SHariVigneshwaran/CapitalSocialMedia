...
class CreatehighlightWidget extends StatefulWidget {
  const CreatehighlightWidget({Key? key}) : super(key: key);

  @override
  _CreatehighlightWidgetState createState() => _CreatehighlightWidgetState();
}

class _CreatehighlightWidgetState extends State<CreatehighlightWidget> {
  bool isMediaUploading = false;
  String uploadedFileUrl = '';

  TextEditingController? dogNameController;
  TextEditingController? dogTypeController;
  ...
  void initState() {
    ...
    dogTypeController = TextEditingController();
                      ...
                      children: [
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              context.pushNamed('createprofilenew');
                            },
                            text: 'Skip',
