    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'group_name':
          ...
          break;
        case 'group_desc':
          result.groupDesc = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String?;
          break;
        case 'group_members':
...
class UserPostsRecordBuilder
  ...
  String? _groupDesc;
  String? get groupDesc => _$this._groupDesc;
  set groupDesc(String? groupDesc) => _$this._groupDesc = groupDesc;

  String? _groupMembers;
  String? get groupMembers => _$this._groupMembers;
  set groupMembers(String? groupMembers) => _$this._groupMembers = groupMembers;
