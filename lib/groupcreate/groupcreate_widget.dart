...
class _GroupcreateWidgetState extends State<GroupcreateWidget> {
  ...
  TextEditingController? grpDecController;
  ...
  void initState() {
    super.initState();
    grpDecController = TextEditingController();
    grpNameController = TextEditingController();
  }

  @override
  void dispose() {
    grpDecController?.dispose();
                      ...
                      Padding(
                        ...
                        child: StreamBuilder<List<GroupsRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<GroupsRecord> buttonSecondaryGroupsRecordList =
                                snapshot.data!;
                            return FFButtonWidget(
                              onPressed: () async {
                                final groupsCreateData = createGroupsRecordData(
                                  groupDec: valueOrDefault(
                                      currentUserDocument?.groupDec, ''),
                                  groupName: valueOrDefault(
                                      currentUserDocument?.groupName, ''),
                                  groupDp: uploadedFileUrl3,
